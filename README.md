...
Brollup is a Bitcoin rollup design tailored for payments and smart contracts that works with a native Bitcoin peg and requires no changes to the Bitcoin protocol. Unlike other rollup constructions, Brollup operates in a layer-two setting with unilateral exit and does not rely on any trust assumptions.
