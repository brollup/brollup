use crate::constructive::cpe::{
    ...
    decode_error::{
        ...
        valtype_error::{
            CommonLongValCPEDecodingError, CommonShortValCPEDecodingError,
            MaybeCommonCPEDecodingError,
        },
    },
};
...
const COMMON_LONG_BITSIZE: u8 = 7;
...
impl CommonLongVal {
    ...
    pub fn decode_cpe(bit_stream: &mut bit_vec::Iter<'_>) -> Result<Self, CPEDecodingError> {
        ...
        for _ in 0..COMMON_LONG_BITSIZE {
            let bit = bit_stream
                ...
                .ok_or(CPEDecodingError::MaybeCommonCPEDecodingError(
                    MaybeCommonCPEDecodingError::CommonLongValCPEDecodingError(
                        CommonLongValCPEDecodingError::BitStreamIteratorError,
                    ),
                ))?;
        ...
        // Decode index.
        let index = u8::from_bits(&bits, COMMON_LONG_BITSIZE).ok_or(
        ...
        let value: u64 = match index {
            ...
            _ => {
                return Err(CPEDecodingError::MaybeCommonCPEDecodingError(
                    MaybeCommonCPEDecodingError::CommonLongValCPEDecodingError(
                        CommonLongValCPEDecodingError::UncommonInteger,
                    ),
                ))
            }
        };
...
impl CompactPayloadEncoding for CommonLongVal {
