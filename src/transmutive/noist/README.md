...
#### Running The Polynomial
The algorithm _RunPolynomial_ constructs a polynomial with coefficients drawn uniformly at random and returns a list of shares and their commitments generated by evaluating the polynomial.

Algorithm _RunPolynomial(s, t, n)_:
    -   The polynomial secret _s_: a secp scalar.
